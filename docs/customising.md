...
Kinetics can add a page where people change the panel's colours, shape, font,
dark mode and layout from inside the panel. It's off unless you turn it on.
See [The Appearance page](appearance-page.md).
